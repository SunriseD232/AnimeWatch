...
final class OfflineDownloadManager: NSObject {
    ...
    /// .sync — лишняя нагрузка на диск, конкурирующая с записью самих
    /// сегментов. Не было основной причиной зависания намертво (тот случай —
    /// отдельный deadlock через NotificationCenter, см. addObserver в
    /// DownloadsViewModel.init()), но экономит реальный I/O. Прогресс на
