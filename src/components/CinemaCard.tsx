...
import type { CinemaShort } from '@/lib/kodik-catalog';

/**
 * Карточка фильма/сериала. Постеры Kodik приходят с разнородных хостов
 * (Кинопоиск/IMDb/TMDB), поэтому используем обычный <img> без next/image —
