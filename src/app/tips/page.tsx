...
const CINEMA_PLAYERS: PlayerNote[] = [
  ...
  },
  {
    name: 'Kodik',
    status: 'exact',
    note: 'Плеер сам сообщает точное время воспроизведения через мост postMessage. Скрыт из переключателя (виден только если явно включён в профиле, либо как единственный доступный вариант).',
  },
];
