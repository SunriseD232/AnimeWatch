...
|-----------|------------------|-----|
| 1.4.6 Contrast (Enhanced) | **7:1** normal / **4.5:1** large (AA was 4.5/3) | Verify `text.primary` (already ~15:1 (pass) ); bump `text.secondary` pairings; check `scripts/design/contrast.py` |
...
## Verification
- Run `scripts/design/contrast.py` against 7:1 for all body-text pairings.
