...
- `python3 scripts/design/validate_tokens.py` — valid JSON, all aliases resolve.
- `python3 scripts/design/validate_contrast.py` — required text/action/border pairs pass WCAG AA in **light AND dark**; `border.strong` ≥ 3:1.
- `python3 scripts/design/validate_theme_refs.py` — every component `var(--…)` resolves to the theme.
