...
```
node scripts/design/taste_audit.mjs <file> && node scripts/design/taste_audit.mjs <file> --dark
node scripts/design/slop_tells.mjs  <file> && node scripts/design/slop_tells.mjs  <file> --dark
node scripts/design/verify_overflow.mjs   <file|dir>
node scripts/design/verify_responsive.mjs <file|dir>
```
