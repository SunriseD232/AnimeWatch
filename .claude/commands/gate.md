...
1. Run: `node scripts/design/accuracy_report.mjs`
...
4. For any rendered HTML touched this session, also run the pixel-truth checks
   ...
   - `node scripts/design/verify_states.mjs <file> [--dark]`
   - `node scripts/design/verify_responsive.mjs <file>`
...
They do not prove taste. Pair with `node scripts/design/taste_audit.mjs` + human review;
