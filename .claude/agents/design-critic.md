...
```
node scripts/design/taste_audit.mjs <file> [--dark]      type scale, uniform repetition, measure, palette
node scripts/design/slop_tells.mjs  <file> [--dark]      radius, elevation, gradient, neutrals, placeholders
node scripts/design/verify_overflow.mjs <file|dir>       clipped text, overlapping controls
node scripts/design/verify_responsive.mjs <file|dir>     280 / 320 / 414
```
