...
- **Figma → Code (extract):** designers manage Variables; export DTCG JSON (Tokens Studio export or REST `GET variables`) → overwrite `tokens/*.json` → run `scripts/design/validate_tokens.py`. Use when design owns tokens.
